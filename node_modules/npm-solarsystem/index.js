...
module.exports.getMercury = function Mercury() {
    const mercury = {
        image: 'https://cdn.mos.cms.futurecdn.net/fjbeeRiPRQjQNhizwy7cWX-650-80.jpg.webp',
...
module.exports.getNeptune = function Neptune() {
    const neptune = {
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Neptune_Voyager2_color_calibrated.png/960px-Neptune_Voyager2_color_calibrated.png',
